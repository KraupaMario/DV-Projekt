...
public class Client2 implements Runnable {
	...
	public void kontostandanzeigen (Spiel s) {
		bo.kontostandSpieler1.setText(("Kontostand betr‰gt"+ Integer.toString(playerS.getKontostand());
		bo.kontostandSpieler2.setText(("Kontostand betr‰gt" + Integer.toString(playerC.getKontostand());
	}
	 */
	...
	public void jeton10() {
		...
		cbo.einsatzausgabeSpieler2C.setText("Der Einsatz betr‰gt:" +swischespeicher);
	...
	public void einsatzAnzeigenGegenspieler() {
		...
		cbo.einsatzausgabeSpieler1C.setText("Der Einsatz betr‰gt:" + Spiel.getGesetztSpieler1());
	}
